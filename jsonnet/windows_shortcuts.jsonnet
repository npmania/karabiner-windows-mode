...

{
  ...
  rules: [
    ...
    k.rule('0 (Ctrl)',
           k.input('0', ['control']),
           k.outputKey('0', ['command']),
           k.condition('unless', bundle.standard, file_paths.standard)),
    k.rule('1 (Ctrl)',
           k.input('1', ['control']),
           k.outputKey('1', ['command']),
           k.condition('unless', bundle.standard, file_paths.standard)),
    k.rule('2 (Ctrl)',
           k.input('2', ['control']),
           k.outputKey('2', ['command']),
           k.condition('unless', bundle.standard, file_paths.standard)),
    k.rule('3 (Ctrl)',
           k.input('3', ['control']),
           k.outputKey('3', ['command']),
           k.condition('unless', bundle.standard, file_paths.standard)),
    k.rule('4 (Ctrl)',
           k.input('4', ['control']),
           k.outputKey('4', ['command']),
           k.condition('unless', bundle.standard, file_paths.standard)),
    k.rule('5 (Ctrl)',
           k.input('5', ['control']),
           k.outputKey('5', ['command']),
           k.condition('unless', bundle.standard, file_paths.standard)),
    k.rule('6 (Ctrl)',
           k.input('6', ['control']),
           k.outputKey('6', ['command']),
           k.condition('unless', bundle.standard, file_paths.standard)),
    k.rule('7 (Ctrl)',
           k.input('7', ['control']),
           k.outputKey('7', ['command']),
           k.condition('unless', bundle.standard, file_paths.standard)),
    k.rule('8 (Ctrl)',
           k.input('8', ['control']),
           k.outputKey('8', ['command']),
           k.condition('unless', bundle.standard, file_paths.standard)),
    k.rule('9 (Ctrl)',
           k.input('9', ['control']),
           k.outputKey('9', ['command']),
           k.condition('unless', bundle.standard, file_paths.standard)),
    k.rule('- (Ctrl)',
           k.input('hyphen', ['control']),
           k.outputKey('hyphen', ['command']),
           k.condition('unless', bundle.standard, file_paths.standard)),
    k.rule('= (Ctrl)',
           k.input('equal_sign', ['control']),
           k.outputKey('equal_sign', ['command']),
           k.condition('unless', bundle.standard, file_paths.standard)),
